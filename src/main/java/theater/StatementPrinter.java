...
public class StatementPrinter {
    ...
    /**
     * Create a new StatementPrinter that will print statements for the given invoice
     * and set of plays.
     *
     * @param invoice the invoice to print
     * @param plays   the mapping of play identifiers to play information
     */
    ...
    // Package-private getters for later refactoring steps (Split Phase etc.).
    Invoice getInvoice() {
        return invoice;
    }
